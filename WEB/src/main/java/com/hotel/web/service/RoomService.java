...
import com.hotel.web.exception.InteralServerException;
import com.hotel.web.exception.ResouceNotFoundException;
import com.hotel.web.model.Room;
import com.hotel.web.repository.RoomRepository;
...
public class RoomService implements IRoomService {
    ...
    public Room updateRoom(Long roomId, String roomType, BigDecimal roomPrice, byte[] photoBytes) {
        Room room = roomRepository.findById(roomId).orElseThrow(() -> new ResouceNotFoundException("Sorry, Room not found"));
        if (roomType != null) {
            room.setRoomType(roomType);
        }
        if(roomPrice != null) {
