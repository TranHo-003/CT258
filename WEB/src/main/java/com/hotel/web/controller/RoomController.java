...
import com.hotel.web.exception.PhotoRetrievalException;
import com.hotel.web.exception.ResouceNotFoundException;
import com.hotel.web.model.BookedRoom;
import com.hotel.web.model.Room;
import com.hotel.web.response.BookingResponse;
import com.hotel.web.response.RoomResponse;
import com.hotel.web.service.BookingService;
import com.hotel.web.service.IRoomService;
...
//                .stream()
//                .map(booking -> new BookingResponse( booking.getBookingConfirmationCode(),booking.getBookingId(), booking.getCheckInDate(), booking.getCheckOutDate())).toList();
        byte[] photoByte = null;
